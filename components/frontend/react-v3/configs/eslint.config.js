    ...
    rules: {
      ...
      '@typescript-eslint/naming-convention': [
        'error',
        {
          ...
          format: ['UPPER_CASE'],
          filter: {
            // Do not enforce on typical camelCase consts (functions/components, etc.)
            regex: '^(?:[A-Z_][A-Z0-9_]*|[A-Z][a-zA-Z0-9]+)$',
            match: false,
          },
        },
      ],
      ...
      // Enforce no magic numbers (only allow -1, 0, 1)
      ...
      // Disallow all string literals (including template literals) — require constants
      'no-restricted-syntax': [
        'error',
        {
          selector: "Literal[raw=/^(?:'|\").*(?:'|\")$/]",
          message: 'No hardcoded strings. Use named constants.',
        },
        {
